...
<h3>Update your film</h3>
	<form action="updateFilm.do" method="POST">
		...
		<br><br>
		<b>Title:</b>
		<input type="text" name="title" oninput="validity.valid||(value='');" value="${film.title}" size="20"/><br> 
		<br><b>Description:</b>
		...
		<br><b>Language:</b> (Current is ${film.language })
		...
		<br><b>Rating:</b> (Current is ${film.rating })
		...
		<br><b>Special Features:</b> (Current feature(s) is: ${film.specialFeatures })
